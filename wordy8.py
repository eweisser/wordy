# Last version, 7, tried to guess words containing letters that have been established as absent from the user's secret word. It also aimed to simplify existing code, and used the idea of a "gate" that opens once an anagram of the user's word is guessed, allowing the computer to look at the entire dictionary at a time.
# This version, 8, I plan to get the program to keep track of how many zero-letters are in candidate words, and choose words that have two or three when possible.
...
def compTakesAGuess():
    ...
    if random() < 0.0000001 and turnNumber > 9:     # A very small chance to pick a random word; basically a placeholder in case I want to increase the odds later
        ...
        if random() < turnNumber / 60:	# more likely to choose (M) maximum-scoring word as time goes by (by turn 30, 50%)
            currentCompGuess = candidateList[candidateMultiplyScoreList.index(max(candidateMultiplyScoreList))]
            print ("!!!!!!!!!!!!!!!turnNumber/300 exceeded!")
            #print (candidateMultiplyScoreList)
            ...
            if 4 in candidateZeroCountList:
                ...
                #print ("If the list has a candidate with 4 ruled out letters, the first one is:")
                #print (candidateList[candidateZeroCountList.index(4)])
                ...
                #print ("If the list has a candidate with 3 ruled out letters, the first one is:")
                #print (candidateList[candidateZeroCountList.index(3)])
                ...
                #print ("If the list has a candidate with 2 ruled out letters, the first one is:")
                #print (candidateList[candidateZeroCountList.index(2)])
                ...
                #print ("If the list has a candidate with 1 ruled out letter, the first one is:")
                #print (candidateList[candidateZeroCountList.index(1)])
