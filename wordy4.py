...
def compTakesAGuess():
    ...
    if random() < 0.0000001 and turnNumber > 9:
        currentCompGuess = dictionary[math.floor(random()*len(dictionary))] # comp picks a random word
    else:
        candidateList = []
        candidateScoreList = []
        for z in range(1000): # don't look at every word in the dictionary, just get 500
        ...
        if random() < 0.5:
            ...
            currentCompGuess = candidateList[candidateScoreList.index(min(candidateScoreList))]
        while currentCompGuess in alreadyGuessedList:
            candidateList.remove(currentCompGuess)
            candidateScoreList.pop(candidateScoreList.index(max(candidateScoreList)))
            print ("repeat!")
            currentCompGuess = candidateList[candidateScoreList.index(max(candidateScoreList))]
            # currentCompGuess = dictionary[math.floor(random()*len(dictionary))]

    if turnNumber % 10 == 1 and turnNumber != 11:
        print ("My " + str(turnNumber) + "st guess is '" + currentCompGuess + "'. How many letters do I have right?")
    elif turnNumber % 10 == 2 and turnNumber != 12:
        print ("My " + str(turnNumber) + "nd guess is '" + currentCompGuess + "'. How many letters do I have right?")
    elif turnNumber % 10 == 3 and turnNumber != 13:
        print ("My " + str(turnNumber) + "rd guess is '" + currentCompGuess + "'. How many letters do I have right?")
    else:
        print ("My " + str(turnNumber) + "th guess is '" + currentCompGuess + "'. How many letters do I have right?")
    alreadyGuessedList.append(currentCompGuess)
    ...
    if currentUserFeedback == 0:					# If the word matches 1 letter, each letter's score increases by 2.
        for x in range(5):							# If the word matches 2 letters, each letter's score increases by 4.
            if currentCompGuess[x] == "a":			# If the word matches 3 letters, each letter's score increases by 10.
                aScore *= 0							# If the word matches 4 letters, each letter's score increases by 50.
