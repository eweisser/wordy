...
from random import random # There are len(dictionary) (5759 last time I checked) words in the dictionary. They'll be #0 to #5758
import math
...
def compTakesAGuess():
    ...
    if random() < 0.5 or turnNumber < 16:
